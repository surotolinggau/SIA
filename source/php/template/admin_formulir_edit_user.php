	...
	<div id="formulir_edit_user" class="admin_formulir_muncul">
		<div id="admin_formulir3">
			<div class="info_kelas">
				...
				<?php
					$tpl_user = tmplUSer($_GET['id_user']);
			...
			<p id="deail_kelas">Edit Data User Pada Sekolah Dasar Negeri 20 Kota Lubuklinggau</p>
				...
				<input type="submit" id="kdk" name="simpan_edit_user" value="Simpan Data">
				<?php } //Endwhile Edit Hak Akses?>
				<?php if($hak_akses == 2){?>
					<input type="submit" id="kdk" name="simpan_edit_user_kepsek" value="Simpan Data">
				<?php } //Endwhile Tombol Edit User Guru?>
				<?php if($hak_akses == 3){?>
					<input type="submit" id="kdk" name="simpan_edit_user_guru" value="Simpan Data">
				<?php } //Endwhile Tombol Edit User Guru?>
				<?php if($hak_akses == 4){?>
					<input type="submit" id="kdk" name="simpan_edit_user_ortu" value="Simpan Data">
				<?php } //Endwhile Tombol Edit User Guru?>
			</form>
			</div>
